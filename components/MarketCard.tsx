      ...
      <div className="flex p-4 gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
            ...
            <span>•</span>
            <span className="text-holiday-red dark:text-red-400">Ends {market.endDate}</span>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 pb-4 mt-auto space-y-3">
        ...
        {analysis ? (
          <div className="bg-gray-50 dark:bg-dark-900/50 p-3 rounded-lg text-xs text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-dark-700 animate-fadeIn">
            <span className="text-purple-600 dark:text-purple-400 font-bold">AI Insight:</span> {analysis}
          </div>
        ) : (
          <button 
          ...
          >
            ...
            {loadingAnalysis ? "Analyzing..." : "Ask Gemini Analyst"}
          </button>
        )}
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          >
            ...
            <span className="text-[10px] opacity-80">Buy at ${market.yesPrice.toFixed(2)}</span>
          </Button>
          <Button 
            variant="danger" 
            size="sm" 
          ...
          >
            ...
            <span className="text-[10px] opacity-80">Buy at ${market.noPrice.toFixed(2)}</span>
          </Button>
        </div>
      </div>
    </div>
