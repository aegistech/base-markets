      ...
      <div className="flex p-4 gap-4">
        <div className="relative">
            ...
            {market.category === 'Crypto' && (
                <div className="absolute -top-1 -right-1 bg-base-500 text-white text-[10px] font-bold px-1.5 rounded-full border border-white dark:border-dark-800">
                    $
                </div>
            )}
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
            ...
            <span>•</span>
            <span className="text-red-500">{t.ends} {market.endDate}</span>
          </div>
        </div>
      </div>
